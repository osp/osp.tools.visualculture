...
VC_URL = 'http://ospwork.constantvzw.org/vc/'
...
MEDIA_ROOT = os.getcwd().split('vc_django')[0] + 'visual'
...
STATICFILES_DIRS = (
    ...
    os.getcwd().split('vc_django')[0] + 'public',
)
...
SECRET_KEY = 'l-3kxu=e)s)h4u4842b27b7226548(70^irqdepa+_ye3'
...
#    'django.contrib.messages.middleware.MessageMiddleware',
    'osp.middleware.ProfileMiddleware'
)
